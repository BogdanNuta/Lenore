(function($) {
  $.fn.tooltip = function(opts) {
    $.fn.tooltip.defaults = {
      offsetX: 10, // X offset relative to cursor
      offsetY: 10, // Y offset relative to cursor
    ...
    Tooltip.prototype = {
      ...
      position: function(x, y) {
		...
		if ((pos.left + this.tooltip.outerWidth()) > $(window).width()) {
			pos.left = pos.left - this.tooltip.outerWidth();
		}
