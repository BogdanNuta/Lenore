...
href="<?php echo lang('help-url'); ?>"><?php echo lang('help'); ?></a> | <a href="javascript:O_LC()"><img 
src="http://cobrand.sympatico.ca/BELL.SYMPATICO.CMS/includes/onlineopinionS3/sm_dgray_red.gif" /> <?php echo lang('feedback'); ?></a>
    </div>
  </div>
</div>
